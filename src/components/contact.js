...
Contact.defaultProps = {
  content5: "Let's start this transformative journey together.",
  address1: '123 Main Street, City, State, Zip Code',
  content3: 'Follow us on social media for updates, tips, and inspiration.',
  phone1: '+1 (123) 456-7890',
  content4:
    'Stay connected with Delo Plenty for the latest news and resources.',
  content1:
    "We'd love to hear from you. Reach out to us for more information or to schedule a consultation.",
  heading1: 'Get in Touch',
  content2:
    "Feel free to send us an email or give us a call. We're here to support you on your journey.",
  email1: 'info@deloplenty.com',
}
